package com.brownjee.andelachallengeapp;
...
import com.brownjee.andelachallengeapp.util.ShareUtils;
import com.bumptech.glide.Glide;

import me.saket.bettermovementmethod.BetterLinkMovementMethod;

public class DevelopersDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        movementMethod.setOnLinkClickListener(new BetterLinkMovementMethod.OnLinkClickListener() {
            ...
            public boolean onClick(TextView textView, String url) {
                getCustomTabIntentInstance().launchUrl(DevelopersDetails.this, Uri.parse(url));
                return true;
            }
        });
    }
